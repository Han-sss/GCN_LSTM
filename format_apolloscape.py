...
def generate_data(file_name, data_type):
    ...
    if data_type == 'train':
        ...
        for object_traj_sequence in cleaned_objects_sequence:
            ...
            one_packaged_sequence = {'trajectory': object_traj_sequence, 
                                     'node_matrix': node_matrix_sequence, 
                                     'graph': graph_sequence}
            
            packaged_sequences.append(one_packaged_sequence)
        
        return packaged_sequences
...
def apolloscape_to_formatted(DATA_DIR, DATA_DIR_TEST, data_type):
    ...
    if data_type == 'train':
        ...
        for train_file_name in train_file_names:
            file_name = DATA_DIR + train_file_name 
            generated_data = generate_data(file_name, data_type)
...
apolloscape_to_formatted(DATA_DIR, DATA_DIR_TEST, data_type)